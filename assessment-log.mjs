...
const USAGE = `Usage:
  bun assessment-log.mjs add --company <name> [--report <num>] --platform <vendor> --subject <topic> [--threshold <pct>] [--score <pct>] [--stale "<note>"]
  bun assessment-log.mjs                         # print the assessment log as JSON
  bun assessment-log.mjs --summary               # print a human-readable summary
  bun assessment-log.mjs --self-test             # run the in-memory test suite
  bun assessment-log.mjs --help                  # print this usage block and exit (-h is an alias)`;
...
function printSummary(result) {
  ...
  if (!assessments.length) {
    ...
    console.log('  Log one: bun assessment-log.mjs add --company <name> --platform <vendor> --subject <topic>');
  } else {
    console.log('  Events:');
