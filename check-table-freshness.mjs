...
const USAGE = `Usage:
  bun check-table-freshness.mjs                       # JSON freshness report
  bun check-table-freshness.mjs --summary             # human-readable table
  bun check-table-freshness.mjs --max-age-months <n>  # review-due threshold (default: 12)
  bun check-table-freshness.mjs --today <YYYY-MM-DD>  # evaluate as of a fixed date
  bun check-table-freshness.mjs --self-test           # run the inline self-test
  bun check-table-freshness.mjs --help                # show this message
