...
const USAGE = `Usage:
  bun classify-tier.mjs "<job-title>"   # print the seniority tier
  bun classify-tier.mjs --test          # run the inline test cases
  bun classify-tier.mjs --help          # show this message
