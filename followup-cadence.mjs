...
const USAGE = `Usage:
  bun followup-cadence.mjs                    # full JSON analysis to stdout
  bun followup-cadence.mjs --json             # same as above, JSON is the default
  bun followup-cadence.mjs --summary          # human-readable dashboard (wins over --json)
  bun followup-cadence.mjs --overdue-only     # only show overdue/urgent entries
  bun followup-cadence.mjs --applied-days 10  # override applied_first cadence (days)
  bun followup-cadence.mjs --help|-h          # print this usage block and exit`;
