 ...
 *      bun invite-match.mjs --apply [--id N]      (rejection-classified matches only; advances status to Rejected)
...
const USAGE = `Usage:
  bun invite-match.mjs < invite.txt          # JSON to stdout
  bun invite-match.mjs --file invite.txt     # read invite text from a file
  bun invite-match.mjs --summary             # human-readable summary instead of JSON
  bun invite-match.mjs --apply [--id N]      # rejection-classified matches only; advances status to Rejected
  bun invite-match.mjs --self-test           # run the built-in self-test suite
  bun invite-match.mjs --help                # print this usage block and exit
  bun invite-match.mjs -h                    # same as --help`;
