...
1b. **Na primeira avaliação de cada sessão:** Executar `bun cv-sync-check.mjs` via Bash. Se houver avisos, informar o candidato antes de continuar
...
| Bash | `bun generate-pdf.mjs`, `bun merge-tracker.mjs` |
