...
// modes are not edited — this lives entirely behind `bun plugins.mjs run notion`.
//
...
//
//   bun plugins.mjs run notion export            # mirror tracker → Notion
//   bun plugins.mjs run notion search "platform" # read matching records → pipeline
