...
const USAGE = `Usage:
  bun process-quality.mjs                        # JSON report
  bun process-quality.mjs --summary              # human-readable table
  bun process-quality.mjs --file <path>          # a different active-interviews.md
  bun process-quality.mjs --min-threshold <N>    # minimum rounds before a company is reported (default 1)
  bun process-quality.mjs --self-test            # run the built-in fixtures
  bun process-quality.mjs --help                 # show this message`;
