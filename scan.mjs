 ...
 *   bun scan.mjs --since 7                    # postings from the last 7 days
 *   bun scan.mjs --posted-after 2026-07-01    # absolute lower bound on posting date
 *   bun scan.mjs --posted-before 2026-08-01   # absolute upper bound on posting date
 *   bun scan.mjs --rediscover-404             # re-verify tracked URLs that 404/410 (rides on --verify)
 *   bun scan.mjs --quiet                      # suppress the manifesto footer
 *   bun scan.mjs --help                       # print this usage block and exit
 */
...
const USAGE = `Usage:
  ...
  bun scan.mjs --posted-after 2026-07-01    # absolute lower bound on posting date
  bun scan.mjs --posted-before 2026-08-01   # absolute upper bound on posting date
  bun scan.mjs --json                       # emit one machine-readable receipt on stdout
  bun scan.mjs --quiet                      # suppress the manifesto footer
  bun scan.mjs --help                       # print this usage block and exit`;
