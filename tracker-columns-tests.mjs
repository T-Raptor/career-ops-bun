...
import { existsSync, readFileSync, writeFileSync, mkdtempSync, mkdirSync, rmSync as _rmSync, utimesSync } from 'fs';
const rmSync = (target, opts = {}) => { try { _rmSync(target, { maxRetries: 10, retryDelay: 100, ...opts }); } catch {} };
