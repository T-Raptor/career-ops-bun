 ...
 *
 * Run: bun tracker-sync-check.mjs              (JSON to stdout)
 *      bun tracker-sync-check.mjs --summary    (human-readable table)
 *      bun tracker-sync-check.mjs --apps-file path/to/applications.md
 *      bun tracker-sync-check.mjs --interviews-file path/to/active-interviews.md
 *      bun tracker-sync-check.mjs --self-test
 *
